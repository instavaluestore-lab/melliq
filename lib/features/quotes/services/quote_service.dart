...
class QuoteService {
  ...
  Future<Quote> createQuote({
    ...
    int highTensionPoleCount = 0,
    int shadeSailCount = 0,
    String? leadId,
    String? notes,
    DateTime? validUntil,
  }) async {
    ...
    final quoteRow = await _supabase
        ...
        .insert({
          ...
          'sealed_engineering_required': sealedEngineeringRequired,
          'high_tension_pole_count': highTensionPoleCount,
          'shade_sail_count': shadeSailCount,
